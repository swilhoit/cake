          ...
          <footer className="py-8 bg-transparent">
            <div className="container mx-auto px-4">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                  ...
                  <p className="text-gray-600">
                    KG Bakery specializes in custom cakes for all occasions. 
                    Our handcrafted cakes are made with premium ingredients and designed to impress.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    ...
                    <li><a href="/shop" className="text-gray-600 hover:text-indigo-600">Shop</a></li>
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    <li><a href="/shipping" className="text-gray-600 hover:text-indigo-600">Shipping Policy</a></li>
                    <li><a href="/returns" className="text-gray-600 hover:text-indigo-600">Returns & Refunds</a></li>
              ...
              <div className="mt-8 pt-8 border-t border-gray-200 text-center">
                <p className="text-gray-600">
                  &copy; {new Date().getFullYear()} KG Bakery. All rights reserved.
                </p>
              </div>
            </div>
          </footer>
